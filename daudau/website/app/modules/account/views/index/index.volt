    ...
    <div class="container recipe-header">
        <div class="rm">
            <div class="recipe-header-info">
                <div class="recipe-header-photo" id="recipe-header-photo-container">
                    <img src="{{ recipe_cook.image.image_base }}" alt="Cách làm {{ recipe_cook.getName() }}" class="photo img-responsive u-photo">
                </div>
                <div class="recipe-header-detail">
                    <div class="recipe-headline">
                        <div class="recipe-type">
                                    <span class="item" style="margin-right:5px">
                                        ...
                                        <span class="type">Ăn trưa</span>
                                    </span>
                            <span class="item" style="margin-right:5px">
                                        <span class="text cuisine-label">Cách thức thực hiện </span>
                                        <span class="type">Chiên</span>
                                    </span>
                        </div>
                        <h1 class="p-name fn recipe-title ">{{ recipe_cook.getName() }}</h1>
                    </div>
                    <div class="recipe-header-stats">
                        ...
                        <ul class="list-inline nomargin nopadding">
                            <li>
                                <div>
                                    <span class="stats-text">Nguyên liệu </span>
                                    <span class="duration-block"><b class="stats-count">13</b></span>
                                </div>
                            </li>
                            <li>
                                <div>
                                    <span class="stats-text"> Thực hiện</span>
                                        <span class="duration">
                                                <span class="duration-block">
                                                    <b class="stats-count"><time title=" PT35M">{{ recipe_cook.getTimeDo() }}</time></b>p
                                                </span>
                                                <span class="value-title" title=" PT35M"></span>
                                        </span>
                                </div>
                            ...
                            <li>
                                <div class="duration">
                                    <span class="stats-text p-yield " value="2">Phần</span>
                                    <span><b class="stats-count">02</b> người</span>
                                </div>
                            </li>
                            <li>
                                <div>
                                    <span class="stats-text">Độ khó</span>
                                    <span><b class="stats-count"> {{ recipe_cook.getLevel() }}</b></span>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="recipe-toolbox" id="recipe-basic-stats">
                    <ul class="recipe-toolbox-items">
                        <li class="tool-item ng-scope" ng-controller="LikeController">
                            <a class="btn-tool" href="javascript:void(0);" title="Yêu Thích" ng-init="init('','190')" ng-click="like()" target="_self">
                                    <span ng-model="isLiked" class="ng-pristine ng-untouched ng-valid ng-empty">
                                        <!-- ngIf: !isLiked --><span ng-if="!isLiked" class="ng-scope">
                                            <span class="fa fa-heart-o ico"></span>
                                            <span class="lbl">Lưu lại</span>
                                        </span><!-- end ngIf: !isLiked -->
                                        <!-- ngIf: isLiked -->
                                    </span>
                            </a>
                            <div class="stat-count">
                                <cooky-user-popup init-data="userLikes" init-config="configLike" init-load="likeLoadMoreUrl" class="ng-isolate-scope"><!-- ngIf: initConfig.text!='' --><span class="btnPopupUser ng-binding ng-scope" ng-if="initConfig.text!=''" ng-click="show()" ng-bind-html="initConfig.text">190</span><!-- end ngIf: initConfig.text!='' -->
                                    <div ng-class="initConfig.containerClass" style="display:none" id="user-like-popup-content">
                                        <div class="users-list-header">
                                            <h4 class="ng-binding">Thịt băm bọc trứng cút sốt cà chua phô mai</h4>
                                            <div class="item-stats ng-binding"><span class="stats-count ng-binding"></span> thành viên thích công thức này</div>
                                        </div>
                                        <div class="users-items-content" style="overflow:auto;height:445px;">
                                            <!-- ngRepeat: item in items -->
                                            <div class="clearfix"></div>
                                            <div ng-show="isLoadingMore" style="text-align:center" class="ng-hide"><img src="/Style/images/icons/small-loading.gif"></div>
                                            <div ng-show="totalRemaining>0" class="recipe-more ng-hide">
                                                <div class="recipe-more-inner">
                                                    <a href="javascript:void(0)" ng-click="loadmore()">Xem thêm</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <li class="tool-item ng-scope" ng-controller="CookController" ng-init="init('','6')">
                            <a class="btn-tool" href="javascript:void(0)" ng-click="cook()" target="_self">
                                    <span ng-model="isCooked" class="ng-pristine ng-untouched ng-valid ng-empty">
                                        <!-- ngIf: !isCooked --><span ng-if="!isCooked" class="fa fa-check ico ng-scope"></span><!-- end ngIf: !isCooked -->
                                        <!-- ngIf: isCooked -->
                                        <span class="lbl">Đã thực hiện</span>
                                    </span>
                            </a>
                            <div class="stat-count">
                                <cooky-user-popup init-data="userCooks" init-config="configCook" init-load="cookLoadMoreUrl" class="ng-isolate-scope"><!-- ngIf: initConfig.text!='' --><span class="btnPopupUser ng-binding ng-scope" ng-if="initConfig.text!=''" ng-click="show()" ng-bind-html="initConfig.text">6</span><!-- end ngIf: initConfig.text!='' -->
                                    <div ng-class="initConfig.containerClass" style="display:none" id="user-cook-popup-content">
                                        <div class="users-list-header">
                                            <h4 class="ng-binding">Thịt băm bọc trứng cút sốt cà chua phô mai</h4>
                                            <div class="item-stats ng-binding"><span class="stats-count ng-binding">0</span> thành viên nấu công thức này</div>
                                        </div>
                                        <div class="users-items-content" style="overflow:auto;height:445px;">
                                            <!-- ngRepeat: item in items -->
                                            <div class="clearfix"></div>
                        ...
                        <li class="tool-item bookmark">
                            <a class="btn-tool ng-isolate-scope" recipe-add-collection-item-popup-full="" option-id="39881" option-name="'Thịt băm bọc trứng cút sốt cà chua phô mai'" option-img="'https://media.cooky.vn/recipe/g4/39881/s640/cooky-recipe-636736014934374374.JPG'" option-total-view="746" option-total-cook-time="6" option-level="'Dễ'" href="javascript:void(0)" title="thêm vào bộ sưu tập" style="outline:none;" target="_self">
                                <span class="fa fa-bookmark-o ico" style="float:none"></span>
                                <span class="lbl">Thêm vào</span>
                            </a>
                        </li>
                    </ul>
                </div>
...
{#                    <li class="active"><a id="nav-detail-panel" href="/cong-thuc/thit-bam-boc-trung-cut-sot-ca-chua-pho-mai-39881" target="_self">Công thức</a></li>#}
{#                    <li class=""><a id="nav-review-panel" href="/cong-thuc/thit-bam-boc-trung-cut-sot-ca-chua-pho-mai-39881/danh-gia" target="_self">Bình luận (<span class="recipe-reviews-count">6</span>)</a></li>#}
{#                    <li class=""><a id="nav-galary-panel" href="/cong-thuc/thit-bam-boc-trung-cut-sot-ca-chua-pho-mai-39881/thu-vien" target="_self">Hình thực hiện (0)</a></li>#}
{#                </ul>#}
{#            </div>#}
{#            <div class="recipe-info">#}
{#                <div class="recipe-profile inner">#}
{#                    <div class="h-card recipe-author">#}
{#                        <div class="user-profile">#}
{#                            <div class="user-info">#}
{#                                <a class="avt" rel="nofollow" href="/thanh-vien/phamson256" target="_self">#}
{#                                    <img class="img-responsive" src="https://media.cooky.vn/usr/g9/80420/avt/c100x100/cooky-avatar-636550029205189540.jpg" alt="Phạm Công Sơn">#}
{#                                </a>#}
{#                                <span style="display:block;color:#b2b2b2;font-size:12px;">công thức bởi</span>#}
{#                                <a href="/thanh-vien/phamson256" target="_self" class="author text-highlight url cooky-user-link p-name u-url" data-userid="80420" data-hasqtip="1" oldtitle="Phạm Công Sơn" title=""> Phạm Công Sơn</a>#}
{#                                <div class="user-stats">#}
{#                                            <span class="stats-item">#}
{#                                                <span class="stats-count">15</span> <span class="stats-text">Công thức</span>#}
{#                                            </span>#}
{#                                    <span class="stats-item">#}
{#                                                <span class="stats-count">89</span> <span class="stats-text">Quan tâm</span>#}
{#                                            </span>#}
{#                                </div>#}
{#                                <div ng-app="collectionHelper" class="ng-scope">#}
{#                                    <button ng-show="visible()" title="Quan tâm" ng-click="follow()" class="btn-follow ng-isolate-scope" ng-class="itemClass()" userid="80420" status="0" type="1">#}
{#                                        <span ng-show="isPosting" class="ng-hide"><img src="/Style/images/icons/small-loading.gif"></span>#}
{#                                        <!-- ngIf: status == 1 -->#}
{#                                        <!-- ngIf: status != 1 --><span ng-if="status != 1" class="ng-scope">Quan tâm</span><!-- end ngIf: status != 1 -->#}
{#                                    </button>#}
{#                                </div>#}
{#                            </div>#}
{#                        </div>#}
...
{#                    <p>Một đứa cuồng thịt như mình thì chắc chắn phải bổ sung món này ngay vào "tủ công thức" rồi. Ôi cắn một viên thịt tròn tròn, bên trong là trứng cút bùi bùi cộng thêm chút sốt cà chua phô mai béo ngậy làm con tim một đứa thích ăn thịt như mình cứ thổn thức mãi thôi. Chia sẻ ngay công thức cho mọi người nè.</p><br>                    </div>#}
{#            </div>#}
            <div class="recipe-body-container">
                <div class="recipe-body">
{#                    <div class="practiced-members-box ng-isolate-scope" lazy-practiced-members-box="" placeholder="practiced-members-box-placeholder" recipe-id="39881">#}
{#                        <!-- ngIf: cookedUsers.length>0 --><div ng-if="cookedUsers.length>0" class="ng-scope">#}
{#                            <div class="practiced-members">#}
{#                                <div class="avt-listing">#}
{#                                    <!-- ngRepeat: item in cookedUsers --><a class="avt ng-scope" href="/thanh-vien/buiminhquanbentre" ng-href="/thanh-vien/buiminhquanbentre" target="_self" ng-repeat="item in cookedUsers">#}
{#                                        <img class="img-responsive img-circle" style="max-width:40px;" ng-src="https://media.cooky.vn/usr/g4/39556/avt/c50x50/cooky-avatar-635979157419094791.jpg" alt="Băng Băng" src="https://media.cooky.vn/usr/g4/39556/avt/c50x50/cooky-avatar-635979157419094791.jpg">#}
{#                                    </a><!-- end ngRepeat: item in cookedUsers --><a class="avt ng-scope" href="/thanh-vien/huongvong98" ng-href="/thanh-vien/huongvong98" target="_self" ng-repeat="item in cookedUsers">#}
{#                                        <img class="img-responsive img-circle" style="max-width:40px;" ng-src="https://media.cooky.vn/usr/g6/51144/avt/c50x50/cooky-avatar-636129169914589127.jpg" alt="Huong Vong" src="https://media.cooky.vn/usr/g6/51144/avt/c50x50/cooky-avatar-636129169914589127.jpg">#}
{#                                    </a><!-- end ngRepeat: item in cookedUsers --><a class="avt ng-scope" href="/thanh-vien/chaly_90" ng-href="/thanh-vien/chaly_90" target="_self" ng-repeat="item in cookedUsers">#}
{#                                        <img class="img-responsive img-circle" style="max-width:40px;" ng-src="https://media.cooky.vn/usr/g6/57840/avt/c50x50/cooky-avatar-636205504618534121.jpg" alt="Linh Linh" src="https://media.cooky.vn/usr/g6/57840/avt/c50x50/cooky-avatar-636205504618534121.jpg">#}
{#                                    </a><!-- end ngRepeat: item in cookedUsers -->#}
{#                                </div>#}
{#                                <div class="name-listing">#}
{#                                    <!-- ngRepeat: item in cookedUsers track by $index --><span ng-repeat="item in cookedUsers track by $index" class="ng-scope">#}
{#                    <a class="name ng-binding" href="/thanh-vien/buiminhquanbentre" ng-href="/thanh-vien/buiminhquanbentre" target="_self">#}
{#                        Băng<!-- ngIf: $index<cookedUsers.length-1 --><span ng-if="$index<cookedUsers.length-1" class="ng-scope">,</span><!-- end ngIf: $index<cookedUsers.length-1 -->#}
{#                    </a>#}

{#                </span><!-- end ngRepeat: item in cookedUsers track by $index --><span ng-repeat="item in cookedUsers track by $index" class="ng-scope">#}
{#                    <a class="name ng-binding" href="/thanh-vien/huongvong98" ng-href="/thanh-vien/huongvong98" target="_self">#}
{#                        Huong<!-- ngIf: $index<cookedUsers.length-1 --><span ng-if="$index<cookedUsers.length-1" class="ng-scope">,</span><!-- end ngIf: $index<cookedUsers.length-1 -->#}
{#                    </a>#}

{#                </span><!-- end ngRepeat: item in cookedUsers track by $index --><span ng-repeat="item in cookedUsers track by $index" class="ng-scope">#}
{#                    <a class="name ng-binding" href="/thanh-vien/chaly_90" ng-href="/thanh-vien/chaly_90" target="_self">#}
{#                        Linh<!-- ngIf: $index<cookedUsers.length-1 -->#}
{#                    </a>#}

{#                </span><!-- end ngRepeat: item in cookedUsers track by $index -->#}
{#                                    <!-- ngIf: remainUsers()>0 --><a class="more ng-binding ng-scope" href="javascript:void(0);" ng-if="remainUsers()>0">#}
{#                                        và 182 người khác#}
{#                                    </a><!-- end ngIf: remainUsers()>0 -->#}
{#                                    <div class="practiced-label">đã thực hiện món này</div>#}
{#                                </div>#}
{#                            </div>#}
{#                            <div class="thumb-photos">#}
{#                                <!-- ngRepeat: photo in cookedPhotos track by $index -->#}
{#                            </div>#}
{#                        </div><!-- end ngIf: cookedUsers.length>0 -->#}
{#                        <!-- ngIf: cookedUsers.length==0 -->#}
{#                        <div class="clearfix">#}
{#                            <button style="margin:0 auto; display:block; margin-top:15px;" class="btn btn-add-photo ng-isolate-scope" recipe-social-cooked-popup="" option-recipe-id="recipeId">#}
{#                                <i class="ico ico-18 ico-iblock ico-photos ico-black"></i> Tải lên hình đã thực hiện#}
{#                            </button>#}
{#                        </div>#}
{#                    </div>#}
{#                    <div class="timeline-wrapper practiced-members-box-placeholder" style="height: 200px; border-radius: 14px; margin-bottom: 10px; display: none;">#}
{#                        <div class="timeline-item">#}
{#                            <div class="animated-background" style="border-radius: 14px;height: 200px;overflow: hidden;display: block;">#}
{#                                <div class="background-masker" style="width: 30px;top: 0;height: 50px;"></div>#}
{#                                <div class="background-masker" style="left: 10px;height: 10px;right: 0;"></div>#}
{#                                <div class="background-masker" style="left: 80px;width: 10px;height: 50px;"></div>#}
{#                                <div class="background-masker" style="left: 80px;height: 15px;right: 0;"></div>#}
{#                                <div class="background-masker" style="left: 240px;height: 45px;top: 0;right: 0;"></div>#}
{#                                <div class="background-masker" style="left: 80px;top: 26px;height: 8px;right: 0;"></div>#}
{#                                <div class="background-masker" style="top: 42px;left: 80px;height: 15px;right: 0;"></div>#}
{#                                <div class="background-masker" style="top: 50px;height: 15px;right: 0;width: 100%;"></div>#}
{#                                <div class="background-masker" style="top: 65px;left: 0;width: 30px;height: 106px;"></div>#}
{#                                <div class="background-masker" style="top: 65px;left: 136px;width: 10px;height: 106px;"></div>#}
{#                                <div class="background-masker" style="top: 65px;left: 252px;width: 10px;height: 106px;"></div>#}
{#                                <div class="background-masker" style="top: 65px;left: 368px;width: 10px;height: 106px;"></div>#}
{#                                <div class="background-masker" style="top: 65px;left: 484px;width: 10px;height: 106px;"></div>#}
{#                                <div class="background-masker" style="top: 65px;left: 600px;width: 10px;height: 106px;"></div>#}
{#                                <div class="background-masker" style="top: 65px;right: 0;width: 30px;height: 106px;"></div>#}
{#                                <div class="background-masker" style="top: 171px;left: 0px;width: 100%;height: 30px;"></div>#}
{#                            </div>#}
{#                        </div>#}
                    </div>
                    <div class="recipe-detail-left sm-wide">
                        <div id="recipe-detail">
{#                            <div class="recipe-ingredient-wrapper" id="ingredients-box">#}
{#                                <div class="recipe-box-heading">#}
{#                                    <div class="col-md-8 col-sm-6 pull-left nopadding">#}
{#                                        <h2 class="title capit"> Nguyên liệu  làm thịt băm bọc trứng cút sốt cà chua phô mai</h2>#}
{#                                        <div class="desc" ng-show="servings>0">#}
{#                                            cho#}
{#                                            <span class="text-highlight"><strong ng-show="false" class="ng-hide">2</strong><strong ng-show="true" class="ng-binding">2</strong></span> Phần ăn#}
{#                                        </div>#}
{#                                    </div>#}
{#                                    <div class="col-md-4 col-sm-6">#}
{#                                        <div class="pull-right">#}
{#                                            <div class="serving-container" style="padding-top: 4px;">#}
{#                                                <span style=""><span class="fa fa-cutlery text-highlight"></span> Phần ăn</span>#}
{#                                                <span>#}
{#                                                                <input type="number" style="height: 24px; margin: 0 5px; padding: 0; text-align: center; width: 32px;" min="1" max="100" onkeypress="numberOnly(event)" class="form-control ng-pristine ng-untouched ng-valid ng-not-empty ng-valid-min ng-valid-max" ng-model="newservings">#}
{#                                                            </span>#}
{#                                                <span>#}
{#                                                                <a href="javascript:void(0)" ng-click="changeServing()" target="_self"><span class="fa fa-refresh text-gray"></span></a>#}
{#                                                            </span>#}
{#                                            </div>#}
{#                                            <div ng-show="servingChanging" style="position: absolute;top: 5px;right: -5px;" class="ng-hide"><img src="/Style/images/icons/small-loading.gif"></div>#}
{#                                        </div>#}
{#                                    </div>#}
{#                                </div>#}
...
{#                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>#}
{#                                                    <li class="ingredient">#}
{#                                                        <span class="name">Thịt heo bằm</span>#}

{#                                                        <span class="amount" style="font-size:12px">#}
{#                                                                                    <span class="ingredient-quality text-gray">100</span>#}
{#                                                                                <span class="ingredient-unit text-gray"> Gr</span>#}
{#                                                                        </span>#}
{#                                                    </li>#}
...
{#                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>#}
{#                                                    <li class="ingredient">#}
{#                                                        <span class="name">Cà chua</span>#}

{#                                                        <span class="amount" style="font-size:12px">#}
{#                                                                                    <span class="ingredient-quality text-gray">2</span>#}
{#                                                                                <span class="ingredient-unit text-gray"> Quả</span>#}
{#                                                                        </span>#}
{#                                                    </li>#}
...
{#                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>#}
{#                                                    <li class="ingredient">#}
{#                                                        <span class="name">Đậu hũ non</span>#}

{#                                                        <span class="amount" style="font-size:12px">#}
{#                                                                                    <span class="ingredient-quality text-gray">50</span>#}
{#                                                                                <span class="ingredient-unit text-gray"> Gr</span>#}
{#                                                                        </span>#}
{#                                                    </li>#}
...
{#                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>#}
{#                                                    <li class="ingredient">#}
{#                                                        <span class="name">Hành tím</span>#}

{#                                                        <span class="amount" style="font-size:12px">#}
{#                                                                                    <span class="ingredient-quality text-gray">10</span>#}
{#                                                                                <span class="ingredient-unit text-gray"> Gr</span>#}
{#                                                                        </span>#}
{#                                                    </li>#}
...
{#                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>#}
{#                                                    <li class="ingredient">#}
{#                                                        <span class="name">Hành lá</span>#}

{#                                                        <span class="amount" style="font-size:12px">#}
{#                                                                                    <span class="ingredient-quality text-gray">5</span>#}
{#                                                                                <span class="ingredient-unit text-gray"> Gr</span>#}
{#                                                                        </span>#}
{#                                                    </li>#}
...
{#                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>#}
{#                                                    <li class="ingredient">#}
{#                                                        <span class="name">Dầu ăn</span>#}

{#                                                        <span class="amount" style="font-size:12px">#}
{#                                                                                    <span class="ingredient-quality text-gray">10</span>#}
{#                                                                                <span class="ingredient-unit text-gray"> ml</span>#}
{#                                                                        </span>#}
{#                                                    </li>#}
...
{#                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>#}
{#                                                    <li class="ingredient">#}
{#                                                        <span class="name">Nước</span>#}

{#                                                        <span class="amount" style="font-size:12px">#}
{#                                                                                    <span class="ingredient-quality text-gray">30</span>#}
{#                                                                                <span class="ingredient-unit text-gray"> ml</span>#}
{#                                                                        </span>#}
{#                                                    </li>#}
...
{#                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>#}
{#                                                    <li class="ingredient">#}
{#                                                        <span class="name">Hạt nêm</span>#}

{#                                                        <span class="amount" style="font-size:12px">#}
{#                                                                                    <span class="ingredient-quality text-gray">2</span>#}
{#                                                                                <span class="ingredient-unit text-gray"> Muỗng canh</span>#}
{#                                                                        </span>#}
{#                                                    </li>#}
...
{#                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>#}
{#                                                    <li class="ingredient">#}
{#                                                        <span class="name">Đường trắng</span>#}

{#                                                        <span class="amount" style="font-size:12px">#}
{#                                                                                    <span class="ingredient-quality text-gray">2</span>#}
{#                                                                                <span class="ingredient-unit text-gray"> Muỗng cà phê</span>#}
{#                                                                        </span>#}
{#                                                    </li>#}
...
{#                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>#}
{#                                                    <li class="ingredient">#}
{#                                                        <span class="name">Tiêu</span>#}

{#                                                        <span class="amount" style="font-size:12px">#}
{#                                                                                    <span class="ingredient-quality text-gray"> &lt;sup&gt;1&lt;/sup&gt;/&lt;sub&gt;2&lt;/sub&gt;</span>#}
{#                                                                                <span class="ingredient-unit text-gray"> Muỗng cà phê</span>#}
{#                                                                        </span>#}
{#                                                    </li>#}
...
{#                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>#}
{#                                                    <li class="ingredient">#}
{#                                                        <span class="name">Nước tương</span>#}

{#                                                        <span class="amount" style="font-size:12px">#}
{#                                                                                    <span class="ingredient-quality text-gray">1</span>#}
{#                                                                                <span class="ingredient-unit text-gray"> Muỗng canh</span>#}
{#                                                                        </span>#}
{#                                                    </li>#}
...
{#                                    </div>#}
{#                                    <div ng-show="true">#}
{#                                        <!-- ngIf: ingredientGroups.length > 0 --><div ng-if="ingredientGroups.length > 0" class="ng-scope">#}

{#                                        </div><!-- end ngIf: ingredientGroups.length > 0 -->#}
...
{#                                </div>#}
                            ...
                            <div class="recipe-ingredient-wrapper" id="ingredients-box">
                                <div class="recipe-box-heading">
                                    <div class="col-md-8 col-sm-6 pull-left nopadding">
                                        <h2 class="title capit"> Nguyên liệu làm {{ recipe_cook.getName() }}</h2>
                                        <div class="desc" ng-show="servings>0">
                                            cho
                                            <span class="text-highlight"><strong ng-show="false" class="ng-hide">5</strong><strong ng-show="true" class="ng-binding">5</strong></span> Phần ăn
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <div class="pull-right">
                                ...
                                <div class="recipe-ingredient-box">
                                    <div ng-show="true"  >
                                        <ul class="list-inline recipe-ingredient-list">
                                            {% if list_recipe_material is not null %}
                                           {% for item in list_recipe_material %}
                                               <li class="recipe-ingredient">
                                                   <ul class="list-inline">
                                                       <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue"> </span></li>
                                                       <li class="ingredient">
                                                           <span class="name">{{ item.rawmaterial.name }}</span>

                                                           <span class="amount" style="font-size:12px">
                                                                                    <span class="ingredient-quality text-gray">{{ item.getNumber() }}</span>
                                                                                <span class="ingredient-unit text-gray"> {{ item.quantitative.code }}</span>
                                                                        </span>
                                                       </li>
                                    ...
                                    <div ng-show="false" class="ng-hide" >
                                        <div ng-if="ingredientGroups.length > 0" class="ng-scope">
                                            <ul class="list-unstyled">
                                               <li class="clearfix ng-scope" ng-repeat="group in ingredientGroups | orderBy:'displayOrder'">
                                                    <ul class="list-inline recipe-ingredient-list">
                                                        <li class="recipe-ingredient ng-scope" ng-repeat="item in getIngredientByGroupId(group.id)">
                                                            <ul class="list-inline">
                                                                <li>
                                                                    <span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue" ng-click="additem(item)" ng-show="!item.IsAdded"> </span>
                                                                    <span title="xóa khỏi giỏ đi chợ" style="cursor: pointer" class="fa fa-minus-circle text-gray ng-hide" ng-click="removeitem(item)" ng-show="item.IsAdded"> </span>
                                                                    <span title="" style="cursor: pointer" class="fa fa-spinner fa-spin text-blue ng-hide" ng-show="item.IsLoading"> </span>
                                                                </li>
                                                                <li>
                                                                    <span ng-repeat="unit in item.Units" style="font-size:12px" class="ng-scope">
                                                                                <span ng-show="$index>0" class="ng-hide">+</span>
                                                                                <span ng-show="unit.QuantityText != ''" class="ingredient-quality text-gray ng-binding" ng-bind-html="unit.QuantityText">20</span>
                                                                                <span class="ingredient-unit text-gray ng-binding">Quả</span>
                                                                            </span>
                                                                    <span class="note ng-hide" style="font-size:10px;margin-top:0;" ng-show="item.Note!=null &amp;&amp; item.Note!=''">
                                                                                <span class="ingredient-note">(<span class="text-italic text-gray ng-binding"></span>)</span>
                                                                            </span>
                                                                </li>
                                                        ...
                                                        <ul class="list-inline">
                                                                ...
                                                                <li>
                                                                    <span ng-repeat="unit in item.Units" style="font-size:12px" class="ng-scope">
                                                                                <span ng-show="$index>0" class="ng-hide">+</span>
                                                                                <span ng-show="unit.QuantityText != ''" class="ingredient-quality text-gray ng-binding" ng-bind-html="unit.QuantityText">150</span>
                                                                                <span class="ingredient-unit text-gray ng-binding">Gr</span>
                                                                            </span><!-- end ngRepeat: unit in item.Units -->
                                                                    <span class="note ng-hide" style="font-size:10px;margin-top:0;" ng-show="item.Note!=null &amp;&amp; item.Note!=''">
                                                                                <span class="ingredient-note">(<span class="text-italic text-gray ng-binding"></span>)</span>
                                                                            </span>
                                                                </li>
                                                        ...
                                                        </li><!-- end ngRepeat: item in getIngredientByGroupId(group.id) --><li class="recipe-ingredient ng-scope" ng-repeat="item in getIngredientByGroupId(group.id)">
                                                            <ul class="list-inline">
                                                                <li>
                                                                    <span title="thêm vào giỏ đi chợ" style="cursor: pointer" class="fa fa-plus-circle text-blue" ng-click="additem(item)" ng-show="!item.IsAdded"> </span>
                                                                    <span title="xóa khỏi giỏ đi chợ" style="cursor: pointer" class="fa fa-minus-circle text-gray ng-hide" ng-click="removeitem(item)" ng-show="item.IsAdded"> </span>
                                                                ...
                                                                <li>
                                                                    <!-- ngIf: item.WikiIngredientUrl!=null && item.WikiIngredientUrl.length>0 -->
                                                                    <!-- ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 --><span class="ingredient-name ng-binding ng-scope" ng-if="item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0">Giò sống</span><!-- end ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 -->
                                                                    <!-- ngIf: item.Brands!=null && item.Brands.length>0 -->
                                                                    <!-- ngRepeat: unit in item.Units --><span ng-repeat="unit in item.Units" style="font-size:12px" class="ng-scope">
                                                                                <span ng-show="$index>0" class="ng-hide">+</span>
                                                                                <span ng-show="unit.QuantityText != ''" class="ingredient-quality text-gray ng-binding" ng-bind-html="unit.QuantityText">100</span>
                                                                                <span class="ingredient-unit text-gray ng-binding">Gr</span>
                                                                            </span><!-- end ngRepeat: unit in item.Units -->
                                                                    <span class="note ng-hide" style="font-size:10px;margin-top:0;" ng-show="item.Note!=null &amp;&amp; item.Note!=''">
                                                                                <span class="ingredient-note">(<span class="text-italic text-gray ng-binding"></span>)</span>
                                                            ...
                                                            <ul class="list-inline">
                                                                ...
                                                                <li>
                                                                    <!-- ngIf: item.WikiIngredientUrl!=null && item.WikiIngredientUrl.length>0 -->
                                                                    <!-- ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 --><span class="ingredient-name ng-binding ng-scope" ng-if="item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0">Trứng gà</span><!-- end ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 -->
                                                                    <!-- ngIf: item.Brands!=null && item.Brands.length>0 -->
                                                                    <!-- ngRepeat: unit in item.Units --><span ng-repeat="unit in item.Units" style="font-size:12px" class="ng-scope">
                                                                                <span ng-show="$index>0" class="ng-hide">+</span>
                                                                                <span ng-show="unit.QuantityText != ''" class="ingredient-quality text-gray ng-binding" ng-bind-html="unit.QuantityText">1</span>
                                                                                <span class="ingredient-unit text-gray ng-binding">Quả</span>
                                                                            </span><!-- end ngRepeat: unit in item.Units -->
                                                                    <span class="note ng-hide" style="font-size:10px;margin-top:0;" ng-show="item.Note!=null &amp;&amp; item.Note!=''">
                                                                                <span class="ingredient-note">(<span class="text-italic text-gray ng-binding"></span>)</span>
                                                            ...
                                                            <ul class="list-inline">
                                                                ...
                                                                <li>
                                                                    <!-- ngIf: item.WikiIngredientUrl!=null && item.WikiIngredientUrl.length>0 -->
                                                                    <!-- ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 --><span class="ingredient-name ng-binding ng-scope" ng-if="item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0">Bột chiên giòn</span><!-- end ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 -->
                                                                    <!-- ngIf: item.Brands!=null && item.Brands.length>0 -->
                                                                    <!-- ngRepeat: unit in item.Units --><span ng-repeat="unit in item.Units" style="font-size:12px" class="ng-scope">
                                                                                <span ng-show="$index>0" class="ng-hide">+</span>
                                                                                <span ng-show="unit.QuantityText != ''" class="ingredient-quality text-gray ng-binding" ng-bind-html="unit.QuantityText">4</span>
                                                                                <span class="ingredient-unit text-gray ng-binding">Muỗng canh</span>
                                                                            </span><!-- end ngRepeat: unit in item.Units -->
                                                                    <span class="note ng-hide" style="font-size:10px;margin-top:0;" ng-show="item.Note!=null &amp;&amp; item.Note!=''">
                                                                                <span class="ingredient-note">(<span class="text-italic text-gray ng-binding"></span>)</span>
                                                                            </span>
                                                            ...
                                                            <ul class="list-inline">
                                                                ...
                                                                <li>
                                                                    <!-- ngIf: item.WikiIngredientUrl!=null && item.WikiIngredientUrl.length>0 -->
                                                                    <!-- ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 --><span class="ingredient-name ng-binding ng-scope" ng-if="item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0">Bột chiên xù</span><!-- end ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 -->
                                                                    <!-- ngIf: item.Brands!=null && item.Brands.length>0 -->
                                                                    <!-- ngRepeat: unit in item.Units --><span ng-repeat="unit in item.Units" style="font-size:12px" class="ng-scope">
                                                                                <span ng-show="$index>0" class="ng-hide">+</span>
                                                                                <span ng-show="unit.QuantityText != ''" class="ingredient-quality text-gray ng-binding" ng-bind-html="unit.QuantityText">4</span>
                                                            ...
                                                            <ul class="list-inline">
                                                                ...
                                                                <li>
                                                                    <!-- ngIf: item.WikiIngredientUrl!=null && item.WikiIngredientUrl.length>0 -->
                                                                    <!-- ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 --><span class="ingredient-name ng-binding ng-scope" ng-if="item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0">Tiêu</span><!-- end ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 -->
                                                                    <!-- ngIf: item.Brands!=null && item.Brands.length>0 -->
                                                                    <!-- ngRepeat: unit in item.Units --><span ng-repeat="unit in item.Units" style="font-size:12px" class="ng-scope">
                                                                                <span ng-show="$index>0" class="ng-hide">+</span>
                                                                                <span ng-show="unit.QuantityText != ''" class="ingredient-quality text-gray ng-binding" ng-bind-html="unit.QuantityText"> <sup>1</sup>/<sub>4</sub></span>
                                                                                <span class="ingredient-unit text-gray ng-binding">Muỗng cà phê</span>
                                                                            </span><!-- end ngRepeat: unit in item.Units -->
                                                                    <span class="note ng-hide" style="font-size:10px;margin-top:0;" ng-show="item.Note!=null &amp;&amp; item.Note!=''">
                                                                                <span class="ingredient-note">(<span class="text-italic text-gray ng-binding"></span>)</span>
                                                                            </span>
                                                            ...
                                                            <ul class="list-inline">
                                                                ...
                                                                <li>
                                                                    <!-- ngIf: item.WikiIngredientUrl!=null && item.WikiIngredientUrl.length>0 -->
                                                                    <!-- ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 --><span class="ingredient-name ng-binding ng-scope" ng-if="item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0">Hạt nêm</span><!-- end ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 -->
                                                                    <!-- ngIf: item.Brands!=null && item.Brands.length>0 -->
                                                                    <!-- ngRepeat: unit in item.Units --><span ng-repeat="unit in item.Units" style="font-size:12px" class="ng-scope">
                                                                                <span ng-show="$index>0" class="ng-hide">+</span>
                                                                                <span ng-show="unit.QuantityText != ''" class="ingredient-quality text-gray ng-binding" ng-bind-html="unit.QuantityText"> <sup>1</sup>/<sub>2</sub></span>
                                                                                <span class="ingredient-unit text-gray ng-binding">Muỗng cà phê</span>
                                                                            </span><!-- end ngRepeat: unit in item.Units -->
                                                                    <span class="note ng-hide" style="font-size:10px;margin-top:0;" ng-show="item.Note!=null &amp;&amp; item.Note!=''">
                                                                                <span class="ingredient-note">(<span class="text-italic text-gray ng-binding"></span>)</span>
                                                            ...
                                                            <ul class="list-inline">
                                                                ...
                                                                <li>
                                                                    <!-- ngIf: item.WikiIngredientUrl!=null && item.WikiIngredientUrl.length>0 -->
                                                                    <!-- ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 --><span class="ingredient-name ng-binding ng-scope" ng-if="item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0">Dầu ăn</span><!-- end ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 -->
                                                                    <!-- ngIf: item.Brands!=null && item.Brands.length>0 -->
                                                                    <!-- ngRepeat: unit in item.Units --><span ng-repeat="unit in item.Units" style="font-size:12px" class="ng-scope">
                                                                                <span ng-show="$index>0" class="ng-hide">+</span>
                                                                                <span ng-show="unit.QuantityText != ''" class="ingredient-quality text-gray ng-binding" ng-bind-html="unit.QuantityText">300</span>
                                                                                <span class="ingredient-unit text-gray ng-binding">ml</span>
                                                                            </span><!-- end ngRepeat: unit in item.Units -->
                                                                    <span class="note ng-hide" style="font-size:10px;margin-top:0;" ng-show="item.Note!=null &amp;&amp; item.Note!=''">
                                                                                <span class="ingredient-note">(<span class="text-italic text-gray ng-binding"></span>)</span>
                                                                            </span>
                                                            ...
                                                            <ul class="list-inline">
                                                                ...
                                                                <li>
                                                                    <!-- ngIf: item.WikiIngredientUrl!=null && item.WikiIngredientUrl.length>0 -->
                                                                    <!-- ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 --><span class="ingredient-name ng-binding ng-scope" ng-if="item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0">Tương ớt</span><!-- end ngIf: item.WikiIngredientUrl==null || item.WikiIngredientUrl.length==0 -->
                                                                    <!-- ngIf: item.Brands!=null && item.Brands.length>0 -->
                                                                    <!-- ngRepeat: unit in item.Units --><span ng-repeat="unit in item.Units" style="font-size:12px" class="ng-scope">
                                                                                <span ng-show="$index>0" class="ng-hide">+</span>
                                                                                <span ng-show="unit.QuantityText != ''" class="ingredient-quality text-gray ng-binding" ng-bind-html="unit.QuantityText">1</span>
                                                        ...
                                                        </li><!-- end ngRepeat: item in getIngredientByGroupId(group.id) -->
                                                    </ul>
                                                </li><!-- end ngRepeat: group in ingredientGroups | orderBy:'displayOrder' -->
                                                <li ng-show="ingredientsList.Ingredients.length>0 &amp;&amp; !isAddAll" class="recipe-ingredient">
                                                    <ul class="list-inline">
                                                        <li ng-click="addall(ingredientsList.Ingredients)"><a class="btn btn-default" target="_self"><span title="thêm tất cả vào giỏ đi chợ" class="fa fa-shopping-cart text-blue" ng-show="!isLoadingAction"></span><span title="+ đang thêm tất cả" class="fa fa-spinner fa-spin text-blue ng-hide" ng-show="isLoadingAction"></span> Thêm tất cả</a></li>
                                                    </ul>
                                                </li>
                                                <li ng-show="isAddAll" class="recipe-ingredient ng-hide">
                                                    <ul class="list-inline">
                                                        <li ng-click="removeall(ingredientsList.RecipeId)">
                                                            <a class="btn btn-default btn-removecart" target="_self"><span title="Xóa tất cả" class="fa fa-minus-circle text-highlight" ng-show="!isLoadingAction"></span><span title="- đang xóa hết" class="fa fa-spinner fa-spin text-blue ng-hide" ng-show="isLoadingAction"></span> Xóa tất cả</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                ...
                                <div class="recipe-direction-box">
                                    <div class="headline">
                                        <h2 class="capit" style="padding-right:120px;">
                                            Cách làm {{ recipe_cook.getName() }}
                                        </h2>
                                        <div class="cooking-time">
                                                        <span class="stats-item">
                                                            <span class="stats-text">Thực hiện</span>
                                                            <span class="duration-block">
                                                                <b class="stats-count">{{ recipe_cook.getTimeDo() }}</b>m
                                                            </span>
                                                        </span>
                                        </div>
...
{#                                                    <button type="button" class="btn btn-default btn-viewmode full active"><span class="fa fa-th-list"></span> Xem đầy đủ</button>#}
{#                                                </div>#}
{#                                                <div class="btn-group" role="group">#}
{#                                                    <button type="button" class="btn btn-default btn-viewmode text-only"><span class="fa fa-file-text-o"></span> Không hình</button>#}
{#                                                </div>#}

                                            </div>
                                        </div>
                                    </div>
                                    <div class="recipe-content ng-scope" ng-controller="StepController" id="recipe-step">
                                        <div class="recipe-direction-box">
                                            <h2>Thực hiện</h2>
                                            <div class="panel-group description" id="accordionDirection">
                                                {% if list_step is not null %}
                                                    {% for item in list_step %}
                                                        <div class="panel panel-default clearfix" id="step-253089">
                                                            <div class="panel-heading">
                                                                <h4 class="panel-title">
                                                                    <a data-toggle="collapse" href="#collapseDirection2" target="_self">
                                                                        Bước <span class="num">{{ item.getCount() }}</span>
                                                                    </a>
                                                                    <a href="javascript:void(0)" class="tick-active" target="_self"><span class="fa fa-circle-o"></span></a>
                                                                </h4>
                                                            </div>
                                                            <div id="collapseDirection2" class="panel-collapse collapse in">
                                                                <div class="panel-body has-photo">
                                                                    ...
                                                                    <div class="recipe-step-tip">
                                                                        <p><span class="fa fa-lightbulb-o"></span> Dùng đậu hũ non trộn với thịt bằm giúp viên thịt khi chín ăn không bị khô.<a href="{0}" title="open reference" target="_blank"></a><a href="{0}" title="open reference" target="_blank"></a></p>
                                                                    </div>
...
{#                                                        <div class="panel-body has-photo">#}
{#                                                            <div class="step-desc">#}
{#                                                                Cho 50gr đậu hũ non, 5gr hành tím, 5gr hành lá vào tô thịt bằm. Sau đó nêm thêm 1tbs hạt nêm, 1tsp đường, 1/2 tsp tiêu, 1tbs nước tương, 1tbs nước mắm. Trộn đều các nguyên liệu và sau đó ướp khoảng 10-15 phút cho thịt ngấm đều gia vị bạn nhé. Lấy khoảng 12gr thịt đã tẩm ướp dàn đều lên tay và đặt 1 trái trứng cút vào giữa, vo tròn lại sao cho thịt ôm trọn lấy trứng là thành công nhé các bạn.#}
{#                                                            </div>#}
{#                                                            <div class="recipe-step-tip">#}
{#                                                                <p><span class="fa fa-lightbulb-o"></span> Dùng đậu hũ non trộn với thịt bằm giúp viên thịt khi chín ăn không bị khô.<a href="{0}" title="open reference" target="_blank"></a><a href="{0}" title="open reference" target="_blank"></a></p>#}
{#                                                            </div>#}
{#                                                            <div class="step-photos col2">#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389732" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736021738917719.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736021738917719.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736021738917719.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389731" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736021740167579.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736021740167579.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736021740167579.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389743" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736024872136574.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736024872136574.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736024872136574.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389742" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736024871042870.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736024871042870.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736024871042870.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                            </div>#}
{#                                                            <div class="comment-widget-box step-comments-box" style="display: none;">#}
{#                                                                <cooky-like-comment-widget ref-root-id="39881" ref-id="253089" ref-type="11" environment="'recipestep'" class="ng-isolate-scope"><div ng-show="loading" class="ng-hide">#}

{#                                                                    </div>#}
{#                                                                    <div ng-show="!loading" class="">#}
{#                                                                        <div class="photo-viewer-act-links">#}
{#                                                                            <div class="btn-group">#}
{#                                                                                <div style="float:left">#}
{#                                                                                    <a class="btn btn-default ng-binding" ng-click="gotocommentbox()"><span class="fa fa-comment"></span>&nbsp;thảo luận&nbsp;<span class="count ng-binding">(0)</span></a>#}
{#                                                                                    <span ng-show="options.hasCommentCollapse" style="padding-left: 5px;margin-top:8px; cursor:pointer; float:left" ng-click="collapseCommentToggle()" class="fa fa-caret-square-o-down fa-caret-square-o-up ng-hide" ng-class="{'fa-caret-square-o-down':options.commentCollapse,'fa-caret-square-o-up':!options.commentCollapse}"></span>#}
{#                                                                                </div>#}
{#                                                                                <!-- ngIf: options.canLike --><div style="float:left" ng-if="options.canLike" class="ng-scope">#}
{#                                                                                    <a style="float:left; padding:6px 3px" class="btn btn-default ng-binding" ng-click="likePress()">#}
{#                                                                                        <span ng-class="{'fa-heart text-highlight':model.isLiked,'fa-heart-o':!model.isLiked}" class="fa fa-heart-o"></span>&nbsp;thích#}
{#                                                                                    </a>&nbsp;#}

{#                                                                                    <a class="cooky-total-like" style="float:left; padding:6px 0px" href="javascript:void(0)" data-refid="253089" data-reftype="11" data-hasqtip="52">#}
{#                                                                                        <span class="count ng-binding">(0)</span>#}
{#                                                                                    </a>#}
{#                                                                                </div><!-- end ngIf: options.canLike -->#}
{#                                                                            </div>#}
{#                                                                        </div>#}
{#                                                                        <div ng-hide="options.commentCollapse">#}
{#                                                                            <div ng-show="model.totalRemainingComments>0" class="comment-more ng-hide">#}
{#                                                                                <a style="color: #2a6496;" href="javascript:void(0)" ng-click="loadComments()" class="ng-binding">Xem thêm thảo luận khác  0/0 »</a>#}
{#                                                                            </div>#}
{#                                                                            <div class="photo-viewer-comments-container" style="overflow-y: auto; max-height:418px">#}
{#                                                                                <!-- ngIf: model.comments.length>0 -->#}
{#                                                                                <!-- ngIf: model.comments.length==0 --><div ng-if="model.comments.length==0" class="nocomments ng-scope">#}
{#                                                                                    <span class="ng-binding">Chưa có thảo luận nào</span>#}
{#                                                                                </div><!-- end ngIf: model.comments.length==0 -->#}
{#                                                                            </div>#}
{#                                                                            <div class="photo-comment-box ng-hide" ng-show="model.currentUser!=null" ng-class="{'comment-box-highlight':imagesQueue.length>0}">#}
{#                                                                                <div class="photo-comment-box-profile">#}
{#                                                                                    <img alt="">#}
{#                                                                                </div>#}
{#                                                                                <div class="comment-box">#}
{#                                                                                    <textarea id="recipestepcommentbox-11-253089" style="max-height: 100px; line-height: 11px; font-size: 11px; overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 45.2px;" ng-readonly="isPostingComment" ng-model="model.commentText" class="form-control ng-pristine ng-untouched ng-valid ng-empty" ng-keypress="commentKeypress($event)" contenteditable="true" placeholder="thảo luận của bạn..."></textarea>#}
{#                                                                                    <span ng-show="isPostingComment" style="position: absolute; right: 40px; top: 18px;" class="ng-hide"><img src="/Style/images/icons/small-loading.gif"></span>#}
{#                                                                                    <!-- ngIf: options.commentUploadImage -->#}
{#                                                                                </div>#}

{#                                                                            </div>#}
{#                                                                        </div>#}
{#                                                                    </div>#}
{#                                                                </cooky-like-comment-widget>#}
{#                                                            </div>#}
{#                                                        </div>#}
{#                                                    </div>#}
{#                                                </div>#}
{#                                                <div class="panel panel-default clearfix" id="step-253092">#}
{#                                                    <div class="panel-heading">#}
{#                                                        <h4 class="panel-title">#}
...
{#                                                        <div class="panel-body has-photo">#}
{#                                                            <div class="step-desc">#}
{#                                                                Làm nóng dầu ăn trên chảo, sau đó cho lần lượt các viên thịt vào, chiên cho thịt chín, bên ngoài vàng đều, cháy xém nhẹ một chút là cực ngon rồi nha.#}
{#                                                            </div>#}
{#                                                            <div class="step-photos col2">#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389744" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736025562034867.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736025562034867.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736025562034867.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389745" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736025571565899.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736025571565899.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736025571565899.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                            </div>#}
{#                                                            <div class="comment-widget-box step-comments-box" style="display: none;">#}
{#                                                                <cooky-like-comment-widget ref-root-id="39881" ref-id="253092" ref-type="11" environment="'recipestep'" class="ng-isolate-scope"><div ng-show="loading" class="ng-hide">#}
...
{#                                                                                    <a class="cooky-total-like" style="float:left; padding:6px 0px" href="javascript:void(0)" data-refid="253092" data-reftype="11" data-hasqtip="53">#}
{#                                                                                        <span class="count ng-binding">(0)</span>#}
{#                                                                                    </a>#}
{#                                                                                </div><!-- end ngIf: options.canLike -->#}
{#                                                                            </div>#}
...
{#                                                                                </div>#}
{#                                                                                <div class="comment-box">#}
{#                                                                                    <textarea id="recipestepcommentbox-11-253092" style="max-height: 100px; line-height: 11px; font-size: 11px; overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 45.2px;" ng-readonly="isPostingComment" ng-model="model.commentText" class="form-control ng-pristine ng-untouched ng-valid ng-empty" ng-keypress="commentKeypress($event)" contenteditable="true" placeholder="thảo luận của bạn..."></textarea>#}
{#                                                                                    <span ng-show="isPostingComment" style="position: absolute; right: 40px; top: 18px;" class="ng-hide"><img src="/Style/images/icons/small-loading.gif"></span>#}
{#                                                                                    <!-- ngIf: options.commentUploadImage -->#}
{#                                                                                </div>#}
...
{#                                                    </div>#}
{#                                                </div>#}
{#                                                <div class="panel panel-default clearfix" id="step-253093">#}
{#                                                    <div class="panel-heading">#}
{#                                                        <h4 class="panel-title">#}
...
{#                                                        <div class="panel-body has-photo">#}
{#                                                            <div class="step-desc">#}
{#                                                                Phần tiếp theo là làm sốt cà chua phô mai, một phần linh hồn của món ăn đây rồi. Mình làm nóng chảo, rồi cho 5ml dầu ăn vào, tiếp theo đun chảy 10gr bơ lạt. Khi bơ lạt tan chảy thì cũng là lúc mình cho thêm hành tím phi lên cho dậy mùi thì cho cà chua vào chảo. Nêm sốt 1tbs nước mắm, 1/2 tbs đường, 2 tbs hạt nêm, đun tới lúc cà chua mềm nhũn và phấn sốt sền sệt là công đoạn làm sốt đã đi được một nửa rồi.#}
{#                                                            </div>#}
{#                                                            <div class="step-photos">#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389765" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736029700770510.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736029700770510.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736029700770510.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389764" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736029695770486.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736029695770486.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736029695770486.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389766" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736029702645497.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736029702645497.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736029702645497.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                            </div>#}
{#                                                            <div class="comment-widget-box step-comments-box" style="display: none;">#}
{#                                                                <cooky-like-comment-widget ref-root-id="39881" ref-id="253093" ref-type="11" environment="'recipestep'" class="ng-isolate-scope"><div ng-show="loading" class="ng-hide">#}
...
{#                                                                                    <a class="cooky-total-like" style="float:left; padding:6px 0px" href="javascript:void(0)" data-refid="253093" data-reftype="11" data-hasqtip="54">#}
{#                                                                                        <span class="count ng-binding">(0)</span>#}
{#                                                                                    </a>#}
{#                                                                                </div><!-- end ngIf: options.canLike -->#}
{#                                                                            </div>#}
...
{#                                                                                </div>#}
{#                                                                                <div class="comment-box">#}
{#                                                                                    <textarea id="recipestepcommentbox-11-253093" style="max-height: 100px; line-height: 11px; font-size: 11px; overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 45.2px;" ng-readonly="isPostingComment" ng-model="model.commentText" class="form-control ng-pristine ng-untouched ng-valid ng-empty" ng-keypress="commentKeypress($event)" contenteditable="true" placeholder="thảo luận của bạn..."></textarea>#}
{#                                                                                    <span ng-show="isPostingComment" style="position: absolute; right: 40px; top: 18px;" class="ng-hide"><img src="/Style/images/icons/small-loading.gif"></span>#}
{#                                                                                    <!-- ngIf: options.commentUploadImage -->#}
{#                                                                                </div>#}
...
{#                                                    </div>#}
{#                                                </div>#}
{#                                                <div class="panel panel-default clearfix" id="step-253098">#}
{#                                                    <div class="panel-heading">#}
{#                                                        <h4 class="panel-title">#}
{#                                                            <a data-toggle="collapse" href="#collapseDirection5" target="_self">#}
{#                                                                Bước <span class="num">5</span>#}
{#                                                            </a>#}
{#                                                            <a href="javascript:void(0)" class="tick-active" target="_self"><span class="fa fa-circle-o"></span></a>#}
{#                                                        </h4>#}
{#                                                    </div>#}
{#                                                    <div id="collapseDirection5" class="panel-collapse collapse in">#}
{#                                                        <div class="panel-body has-photo">#}
{#                                                            <div class="step-desc">#}
{#                                                                Tiếp theo mình cho thêm 10ml nước, 10ml sữa tươi, 5gr sốt phô mai rồi quậy đều cho hỗn hợp hoà quyên với nhau, đun sôi lên thì cho thịt viên vào chảo đảo đều cho thấm sốt. Vậy là mình đã hoàn thành xong món ăn rồi đấy.#}
{#                                                            </div>#}
{#                                                            <div class="step-photos col2">#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389769" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030058206586.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030058206586.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030058206586.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389767" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030061956589.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030061956589.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030061956589.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389768" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030062269392.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030062269392.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030062269392.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389770" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030054925666.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030054925666.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736030054925666.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                            </div>#}
{#                                                            <div class="comment-widget-box step-comments-box" style="display: none;">#}
{#                                                                <cooky-like-comment-widget ref-root-id="39881" ref-id="253098" ref-type="11" environment="'recipestep'" class="ng-isolate-scope"><div ng-show="loading" class="ng-hide">#}
...
{#                                                                                    <a class="cooky-total-like" style="float:left; padding:6px 0px" href="javascript:void(0)" data-refid="253098" data-reftype="11" data-hasqtip="55">#}
{#                                                                                        <span class="count ng-binding">(0)</span>#}
{#                                                                                    </a>#}
{#                                                                                </div><!-- end ngIf: options.canLike -->#}
{#                                                                            </div>#}
...
{#                                                                                </div>#}
{#                                                                                <div class="comment-box">#}
{#                                                                                    <textarea id="recipestepcommentbox-11-253098" style="max-height: 100px; line-height: 11px; font-size: 11px; overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 45.2px;" ng-readonly="isPostingComment" ng-model="model.commentText" class="form-control ng-pristine ng-untouched ng-valid ng-empty" ng-keypress="commentKeypress($event)" contenteditable="true" placeholder="thảo luận của bạn..."></textarea>#}
{#                                                                                    <span ng-show="isPostingComment" style="position: absolute; right: 40px; top: 18px;" class="ng-hide"><img src="/Style/images/icons/small-loading.gif"></span>#}
{#                                                                                    <!-- ngIf: options.commentUploadImage -->#}
{#                                                                                </div>#}
...
{#                                                    </div>#}
{#                                                </div>#}
{#                                                <div class="panel panel-default clearfix" id="step-253099">#}
{#                                                    <div class="panel-heading">#}
{#                                                        <h4 class="panel-title">#}
{#                                                            <a data-toggle="collapse" href="#collapseDirection6" target="_self">#}
{#                                                                Bước <span class="num">6</span>#}
{#                                                            </a>#}
{#                                                            <a href="javascript:void(0)" class="tick-active" target="_self"><span class="fa fa-circle-o"></span></a>#}
{#                                                        </h4>#}
{#                                                    </div>#}
{#                                                    <div id="collapseDirection6" class="panel-collapse collapse in">#}
{#                                                        <div class="panel-body has-photo">#}
{#                                                            <div class="step-desc">#}
{#                                                                Đây là thành phẩm của mình, trông thiệt ngon mắt phải không nào.#}
{#                                                            </div>#}
{#                                                            <div class="step-photos">#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389771" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736032161811908.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736032161811908.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736032161811908.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389773" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736032154624630.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736032154624630.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736032154624630.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                                <a class="cooky-photo" href="javascript:void(0)" data-id="389772" data-group="1" data-dimen=" 1500x1000" target="_self">#}
{#                                                                    <img data-original="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736032160874426.JPG" data-lazy="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736032160874426.JPG" alt="Thịt băm bọc trứng cút sốt cà chua phô mai" class="lazy" src="https://media.cooky.vn/recipe/g4/39881/s300x300/cooky-recipe-636736032160874426.JPG" style="display: inline;">#}
{#                                                                </a>#}
{#                                                            </div>#}
{#                                                            <div class="comment-widget-box step-comments-box" style="display: none;">#}
{#                                                                <cooky-like-comment-widget ref-root-id="39881" ref-id="253099" ref-type="11" environment="'recipestep'" class="ng-isolate-scope"><div ng-show="loading" class="ng-hide">#}
...
{#                                                                                    <a class="cooky-total-like" style="float:left; padding:6px 0px" href="javascript:void(0)" data-refid="253099" data-reftype="11" data-hasqtip="56">#}
{#                                                                                        <span class="count ng-binding">(0)</span>#}
{#                                                                                    </a>#}
{#                                                                                </div><!-- end ngIf: options.canLike -->#}
{#                                                                            </div>#}
...
{#                                                                                </div>#}
{#                                                                                <div class="comment-box">#}
{#                                                                                    <textarea id="recipestepcommentbox-11-253099" style="max-height: 100px; line-height: 11px; font-size: 11px; overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 45.2px;" ng-readonly="isPostingComment" ng-model="model.commentText" class="form-control ng-pristine ng-untouched ng-valid ng-empty" ng-keypress="commentKeypress($event)" contenteditable="true" placeholder="thảo luận của bạn..."></textarea>#}
{#                                                                                    <span ng-show="isPostingComment" style="position: absolute; right: 40px; top: 18px;" class="ng-hide"><img src="/Style/images/icons/small-loading.gif"></span>#}
{#                                                                                    <!-- ngIf: options.commentUploadImage -->#}
{#                                                                                </div>#}
...
{#                                                </div>#}
                                        ...
                                        <ul class="instructions" style="display:none">
                                            <li>bước 1: đầu tiên là sơ chế các nguyên liệu. trứng cút luộc chín sau đó bóc vỏ. cắt hạt lựu lần lượt đậu hũ non, cà chua; băm nhỏ hành tím và cuối cùng là cắt nhỏ hành lá.</li>
                                            <li>bước 2: cho 50gr đậu hũ non, 5gr hành tím, 5gr hành lá vào tô thịt bằm. sau đó nêm thêm 1tbs hạt nêm, 1tsp đường, 1/2 tsp tiêu, 1tbs nước tương, 1tbs nước mắm. trộn đều các nguyên liệu và sau đó ướp khoảng 10-15 phút cho thịt ngấm đều gia vị bạn nhé. lấy khoảng 12gr thịt đã tẩm ướp dàn đều lên tay và đặt 1 trái trứng cút vào giữa, vo tròn lại sao cho thịt ôm trọn lấy trứng là thành công nhé các bạn.
                                                #tip: dùng đậu hũ non trộn với thịt bằm giúp viên thịt khi chín ăn không bị khô.</li>
                                            <li>bước 3: làm nóng dầu ăn trên chảo, sau đó cho lần lượt các viên thịt vào, chiên cho thịt chín, bên ngoài vàng đều, cháy xém nhẹ một chút là cực ngon rồi nha.</li>
                                            <li>bước 4: phần tiếp theo là làm sốt cà chua phô mai, một phần linh hồn của món ăn đây rồi. mình làm nóng chảo, rồi cho 5ml dầu ăn vào, tiếp theo đun chảy 10gr bơ lạt. khi bơ lạt tan chảy thì cũng là lúc mình cho thêm hành tím phi lên cho dậy mùi thì cho cà chua vào chảo. nêm sốt 1tbs nước mắm, 1/2 tbs đường, 2 tbs hạt nêm, đun tới lúc cà chua mềm nhũn và phấn sốt sền sệt là công đoạn làm sốt đã đi được một nửa rồi.</li>
                                            <li>bước 5: tiếp theo mình cho thêm 10ml nước, 10ml sữa tươi, 5gr sốt phô mai rồi quậy đều cho hỗn hợp hoà quyên với nhau, đun sôi lên thì cho thịt viên vào chảo đảo đều cho thấm sốt. vậy là mình đã hoàn thành xong món ăn rồi đấy.</li>
                                            <li>bước 6: đây là thành phẩm của mình, trông thiệt ngon mắt phải không nào.</li>
                                        </ul>
                                    </div>
                                </div>

                            </div>
{#                            <div class="cooked-box cooked-container clearfix">#}
{#                                <div class="headline">#}
{#                                    <h2>#}
{#                                        Hình thực hành món Thịt băm bọc trứng cút sốt cà chua phô mai#}
{#                                    </h2>#}
{#                                    <span class="desc">Cùng chia sẻ thành phẩm của bạn với cộng đồng</span>#}
{#                                </div>#}
{#                                <div class="cooked-listing-container cooked-list row10 ng-isolate-scope" recipe-id="39881">#}
{#                                    <!-- ngRepeat: review in cookedReviews -->#}
{#                                </div>#}
{#                                <div class="mess">#}
{#                                    <div class="center text-center">#}
{#                                        <a href="javascript:void(0);" recipe-social-cooked-popup="" option-recipe-id="39881" class="ng-isolate-scope" target="_self">#}
{#                                            <img src="/Content/img/icons/snap-upload.png" class="cook-promote-ico">#}
{#                                        </a>#}
{#                                    </div>#}
{#                                    <div>#}
{#                                        Bạn đã từng nấu món này chưa!#}
{#                                        <div>Hãy chia sẻ hình ảnh và cách làm của bạn với nhé!</div>#}
{#                                    </div>#}
{#                                    <button class="btn btn-add-photo ng-isolate-scope" recipe-social-cooked-popup="" option-recipe-id="39881">#}
{#                                        <i class="ico ico-18 ico-iblock ico-photos ico-black"></i> Tải lên hình thực hiện#}
{#                                    </button>#}
{#                                </div>#}
{#                                <div class="view-more">#}
{#                                    <a href="/cong-thuc/thit-bam-boc-trung-cut-sot-ca-chua-pho-mai-39881/thu-vien" target="_self">Xem thêm hình thực hành khác</a>#}
{#                                </div>#}
{#                            </div>#}
                            <!--inline review form-->
                            <script>
                                var reviewSettingTexts = ['Dễ', 'Giá cả', 'Ngon'];
                            </script>
                            <!--end inline review form-->
{#                            <div class="recipe-box recipe-review-container clearfix" ng-hide="navUrl=='thu-vien'">#}
{#                                <div class="recipe-review-list">#}
{#                                    <div class="recipe-reviews ng-isolate-scope" grouped-recipe-review-list="" placeholder="recipe-review-placeholder" recipe-id="39881" recipe-name="'Thịt băm bọc trứng cút sốt cà chua phô mai'" recipe-url-rewrite="'thit-bam-boc-trung-cut-sot-ca-chua-pho-mai'">#}
{#                                        <div class="inline-recipe-review-form simple-review-form with-fake-input micro-box">#}
{#                                            <h3 class="title">Bình luận</h3>#}
{#                                            <div class="review-rating-only-list nopadding noborder-box" style="border:none;padding:0;" ng-hide="ratingOnlyOptions.loading || ratingOnlyReviews.length==0">#}
{#                                                <div style="float:left; margin-right:10px;">#}
{#                                                    <!-- ngRepeat: rating in ratingOnlyReviews --><div class="user-info user-rating-only inline-block ng-scope" style="margin-left: -10px;" ng-repeat="rating in ratingOnlyReviews">#}
{#                                                        <div class="avt">#}
{#                                                            <a ng-href="/thanh-vien/vytatamiv" href="/thanh-vien/vytatamiv" target="_self">#}
{#                                                                <img class="img-responsive img-circle" style="max-width:40px;" ng-src="https://media.cooky.vn/usr/g36/350050/avt/c70x70/cooky-avatar-637026952959692032.jpg" alt="vytata" src="https://media.cooky.vn/usr/g36/350050/avt/c70x70/cooky-avatar-637026952959692032.jpg">#}
{#                                                            </a>#}
{#                                                        </div>#}
{#                                                    </div><!-- end ngRepeat: rating in ratingOnlyReviews -->#}
{#                                                </div>#}
{#                                                <div class="user-listing">#}
{#                                                    <!-- ngRepeat: userRating in ratingOnlyReviews track by $index --><div class="inline-block ng-scope" ng-repeat="userRating in ratingOnlyReviews track by $index">#}
{#                                                        <a ng-href="/thanh-vien/vytatamiv" href="/thanh-vien/vytatamiv" target="_self">#}
{#                                                            <strong class="user-name ng-binding">vytata<!-- ngIf: $index < ratingOnlyReviews.length - 1 --></strong>#}

{#                                                        </a>#}
{#                                                    </div><!-- end ngRepeat: userRating in ratingOnlyReviews track by $index -->#}
{#                                                    <div class="inline-block" ng-show="ratingOnlyOptions.totalMembers > ratingOnlyReviews.length">#}
{#                                                        và <span ng-bind="ratingOnlyOptions.totalMembers - ratingOnlyReviews.length" class="ng-binding">1</span> người khác#}
{#                                                    </div>#}
{#                                                    <div class="text-gray">đã đánh giá <span class="ng-binding">(6 rating only)</span></div>#}
{#                                                </div>#}
{#                                            </div>#}
...
{#            </span>#}
{#                                            </div>#}
{#                                            <div class="inline-recipe-review-form-ctrl form-box ng-isolate-scope" recipe-id="recipeId" recipe-name="recipeName" recipe-url-rewrite="recipeUrlRewrite">#}
{#                                                <a class="exit" href="javascript:void(0)">Đóng</a>#}
{#                                                <div class="user">#}
{#                                                    <img class="avt">#}
{#                                                </div>#}
{#                                                <div class="form">#}
...
{#                                                        <div class="form-row">#}
{#                                                            <textarea class="form-control ng-pristine ng-untouched ng-valid ng-empty" name="review-content" id="review-content" ng-model="content" type="text" placeholder="* Mẹo: Nội dung đánh giá phải mang tính chất khách quan, từ chia sẻ đánh giá của bạn sẽ giúp rất nhiều cho người dùng có quyết định lựa chọn đúng đắn. Nội dung hợp lệ là nội dung có từ 100 ký tự trở lên"></textarea>#}
{#                                                            <div class="form-row-desc">#}
{#                                                                <span ng-show="content != null &amp;&amp; content.trim().length > 0" class="ng-hide"><span class="text-highlight">*</span> <b class="text-highlight ng-binding">0</b> Ký tự - Nội dung tối thiểu <b>100</b> Ký tự</span>#}
{#                                                                <span ng-show="content == null || content.trim().length == 0">Rating only - Chưa có nội dung đánh giá</span>#}
{#                                                            </div>#}
{#                                                        </div>#}
{#                                                    </div>#}
{#                                                    <div class="attached-photos-container ng-scope" ng-controller="InlineUploadController as uploadCtrl">#}
{#                                                        <div class="header">#}
{#                                                            <span>Số hình đăng tải (<span class="text-gray text-small ng-binding">Giới hạn 0/9 Hình ảnh </span>)</span>#}
{#                                                            <div class="acts">#}
{#                                                                <button style="background:#fff; border:none;" ng-disabled="disable()" ngf-select="uploadFiles($files, $invalidFiles)" multiple="multiple" accept="image/*" ngf-max-height="10000" ngf-max-width="10000" title="upload on select files" ngf-max-size="10MB">#}
{#                                                                    + tải thêm hình#}
{#                                                                </button>#}
{#                                                            </div>#}
{#                                                        </div>#}
{#                                                        <div class="attached-photos" ng-init="init()">#}
{#                                                            <!-- ngRepeat: photo in photos -->#}
{#                                                            <div class="attached-photo">#}
{#                                                                <button ng-disabled="disable()" class="review-img-upload-box-item" style="background: rgba(243, 244, 243, 0.3)" ngf-select="uploadFiles($files, $invalidFiles)" multiple="multiple" accept="image/*" ngf-max-height="10000" ngf-max-width="10000" title="upload on select files" ngf-max-size="10MB">#}
...
{#                                                                <i class="ico ico-18 ico-block ico-photos ico-black"></i> tải thêm hình#}
{#                                                            </button>#}
...
{#                                            <!-- ngRepeat: review in mainReviews -->#}
{#                                            <div class="recipe-more ng-hide" ng-show="reviewOptions.totalCount<reviewOptions.total" ng-click="loadMainReviews()">#}
{#                                                <div class="recipe-more-inner">#}
{#                                                    <a href="javascript:void(0)">#}
{#                                                        Xem thêm <img src="/Content/img/icons/ajax-loader.gif" ng-show="reviewOptions.loading" style="vertical-align:middle;" class="ng-hide">#}
{#                                                    </a>#}
{#                                                </div>#}
{#                                            </div>#}
{#                                        </div>#}
{#                                    </div>#}
{#                                    <div class="timeline-wrapper recipe-review-placeholder" style="display: none;">#}
{#                                        <div class="timeline-item">#}
...
{#                            </div>#}
        ...
        <div class="rr">
            ...
            <div class="recipe-detail-right sm-wide" id="recipe-detail-right">
                <div class="right-content scrollable-container inner" data-top-control="header" data-wrapper=".recipe-body" data-padding="40">
...
{#                                    <div class="item">#}
{#                                        <div class="photo">#}
{#                                            <a href="/cong-thuc/thit-boc-trung-cut-chien-xu-3084" target="_self" title="Cách làm Thịt Bọc Trứng Cút Chiên Xù giòn béo hấp dẫn">#}
{#                                                <img alt="Cách làm Thịt Bọc Trứng Cút Chiên Xù giòn béo hấp dẫn" src="https://media.cooky.vn/recipe/g1/3084/s320x320/recipe3084-635754047525485946.jpg" class="img-responsive">#}
{#                                            </a>#}
{#                                        </div>#}
{#                                        <div class="info text-ellipsis">#}
{#                                            <a href="/cong-thuc/thit-boc-trung-cut-chien-xu-3084" target="_self" title="Cách làm Thịt Bọc Trứng Cút Chiên Xù giòn béo hấp dẫn" class="name">Thịt bọc trứng cút chiên xù</a>#}
{#                                            <div class="stats">#}
{#                                        <span class="stats-item">#}
{#                                            <span class="stats-count">11.21K</span>#}
{#                                            <span class="stats-text">lượt xem</span>#}
{#                                        </span>#}
{#                                                <span class="stats-item">#}
{#                                            <span class="stats-count">45p</span>#}
{#                                        </span>#}
{#                                            </div>#}
{#                                        </div>#}
{#                                    </div>#}
...
{#                                    <div class="item">#}
{#                                        <div class="photo">#}
{#                                            <a href="/cong-thuc/thit-vien-trung-cut-sot-9719" target="_self" title="Cách làm Thịt viên trứng cút sốt">#}
{#                                                <img alt="Cách làm Thịt viên trứng cút sốt" src="https://media.cooky.vn/recipe/g1/9719/s320x320/cooky-recipe-cover-r9719.jpg" class="img-responsive">#}
{#                                            </a>#}
{#                                        </div>#}
{#                                        <div class="info text-ellipsis">#}
{#                                            <a href="/cong-thuc/thit-vien-trung-cut-sot-9719" target="_self" title="Cách làm Thịt viên trứng cút sốt" class="name">Thịt viên trứng cút sốt</a>#}
{#                                            <div class="stats">#}
{#                                        <span class="stats-item">#}
{#                                            <span class="stats-count">1.44K</span>#}
{#                                            <span class="stats-text">lượt xem</span>#}
{#                                        </span>#}
{#                                                <span class="stats-item">#}
{#                                            <span class="stats-count">35p</span>#}
{#                                        </span>#}
{#                                            </div>#}
...
{#                                    <div class="item">#}
{#                                        <div class="photo">#}
{#                                            <a href="/cong-thuc/thit-boc-trung-cut-chien-gion-44948" target="_self" title="Cách làm Thịt Bọc Trứng Cút Chiên Giòn ngon cho cả nhà">#}
{#                                                <img alt="Cách làm Thịt Bọc Trứng Cút Chiên Giòn ngon cho cả nhà" src="https://media.cooky.vn/recipe/g5/44948/s320x320/cooky-recipe-cover-r44948.jpg" class="img-responsive">#}
{#                                            </a>#}
{#                                        </div>#}
{#                                        <div class="info text-ellipsis">#}
{#                                            <a href="/cong-thuc/thit-boc-trung-cut-chien-gion-44948" target="_self" title="Cách làm Thịt Bọc Trứng Cút Chiên Giòn ngon cho cả nhà" class="name">Thịt bọc trứng cút chiên giòn</a>#}
{#                                            <div class="stats">#}
{#                                        <span class="stats-item">#}
{#                                            <span class="stats-count">316</span>#}
{#                                            <span class="stats-text">lượt xem</span>#}
{#                                        </span>#}
{#                                                <span class="stats-item">#}
{#                                            <span class="stats-count">1h0p</span>#}
{#                                        </span>#}
{#                                            </div>#}
{#                                        </div>#}
{#                                    </div>#}
...
{#                                    <div class="item">#}
{#                                        <div class="photo">#}
{#                                            <a href="/cong-thuc/thit-vien-trung-cut-nuong-23377" target="_self" title="Cách làm thịt viên trứng cút nướng">#}
{#                                                <img alt="Cách làm thịt viên trứng cút nướng" src="https://media.cooky.vn/recipe/g3/23377/s320x320/recipe-cover-r23377.jpg" class="img-responsive">#}
{#                                            </a>#}
{#                                        </div>#}
{#                                        <div class="info text-ellipsis">#}
{#                                            <a href="/cong-thuc/thit-vien-trung-cut-nuong-23377" target="_self" title="Cách làm thịt viên trứng cút nướng" class="name">Thịt viên trứng cút nướng</a>#}
{#                                            <div class="stats">#}
{#                                        <span class="stats-item">#}
{#                                            <span class="stats-count">1.57K</span>#}
{#                                            <span class="stats-text">lượt xem</span>#}
{#                                        </span>#}
{#                                                <span class="stats-item">#}
...
{#                                <span>Từ khóa:</span>#}
{#                                <a href="/cach-lam/thịt-heo-bằm" title="Cách làm thịt heo bằm" target="_self">#}
{#                                    &nbsp;thịt heo bằm&nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i>#}
{#                                </a>#}
{#                            </div>#}
{#                        </div>#}
{#                    </div>#}
                </div>
{#                <div class="right-content scrollable-container inner" data-top-control="header" data-wrapper=".recipe-body" data-padding="40" style="margin-top:15px">#}
{#                    <link href="/dist/css/related.collection.min.css" rel="stylesheet">#}
{#                    <div class="clearfix related-collection">#}
{#                        <div class="collection-list-wrapper">#}
{#                            <div class="headline">#}
{#                                <h3>Bộ sưu tập liên quan</h3>#}
{#                            </div>#}
{#                            <div class="collection-list">#}
{#                                <div class="related-collection-item">#}
{#                                    <div class="collection-item-card">#}
{#                                        <div class="collection-photo">#}
{#                                            <a target="_self" title="Những món ăn đơn giản nhanh chóng với trứng" href="/bo-suu-tap/nhung-mon-an-don-gian-nhanh-chong-voi-trung-275979" class="photo">#}
{#                                                <img alt="Những món ăn đơn giản nhanh chóng với trứng" src="https://media.cooky.vn/collections/g28/275979/s400x400/cooky-collection-cover-c275979.jpg" class="img-responsive">#}
{#                                            </a>#}
{#                                            <div class="collection-item-acts">#}
{#                                                <div class="collection-item-acts-row">#}
{#                                                    <span class="stats-item"><span class="stat-count">102</span> Công thức</span>#}
{#                                                    <button title="thích" class="btn-follow btn-subscribe" data-collectionid="275979" data-issubscribed="False">#}
...
{#                                            <h3 class="title"><a target="_self" href="/bo-suu-tap/nhung-mon-an-don-gian-nhanh-chong-voi-trung-275979" title="Những món ăn đơn giản nhanh chóng với trứng">Những món ăn đơn giản nhanh chóng với trứng</a></h3>#}
{#                                        </div>#}
{#                                        <div class="creator">#}
{#                                            <a class="avatar" href="/thanh-vien/wenkimtuyen/thong-tin" target="_self">#}
{#                                                <img src="https://media.cooky.vn/usr/g10/96128/avt/c80x80/cooky-avatar-636959526416611860.jpg">#}
{#                                            </a>#}
{#                                            <a class="name" href="/thanh-vien/wenkimtuyen/thong-tin" target="_self">#}
{#                                                <span>Tạo bởi</span> BẾP THÁNG 12#}
{#                                            </a>#}
{#                                        </div>#}
{#                                    </div>#}
{#                                </div>#}
...
{#                                    <div class="collection-item-card">#}
{#                                        <div class="collection-photo">#}
{#                                            <a target="_self" title="Trứng cút và những món ngộ nghĩnh" href="/bo-suu-tap/trung-cut-420505" class="photo">#}
{#                                                <img alt="Trứng cút và những món ngộ nghĩnh" src="https://media.cooky.vn/collections/g43/420505/s400x400/cooky-collection-cover-c420505.jpg" class="img-responsive">#}
{#                                            </a>#}
{#                                            <div class="collection-item-acts">#}
{#                                                <div class="collection-item-acts-row">#}
{#                                                    <span class="stats-item"><span class="stat-count">66</span> Công thức</span>#}
{#                                                    <button title="thích" class="btn-follow btn-subscribe" data-collectionid="420505" data-issubscribed="False">#}
{#                                                        <span class="fa fa-bookmark-o"></span>#}
{#                                                    </button>#}
{#                                                </div>#}
{#                                            </div>#}
{#                                        </div>#}
{#                                        <div class="collection-header-box">#}
{#                                            <h3 class="title"><a target="_self" href="/bo-suu-tap/trung-cut-420505" title="Trứng cút và những món ngộ nghĩnh">Trứng cút và những món ngộ nghĩnh</a></h3>#}
{#                                        </div>#}
{#                                        <div class="creator">#}
{#                                            <a class="avatar" href="/thanh-vien/plhnca/thong-tin" target="_self">#}
{#                                                <img src="https://media.cooky.vn/usr/g18/174921/avt/c80x80/cooky-avatar-636882606760634904.jpg">#}
{#                                            </a>#}
{#                                            <a class="name" href="/thanh-vien/plhnca/thong-tin" target="_self">#}
{#                                                <span>Tạo bởi</span> Thymus Vulgaris N#}
{#                                            </a>#}
{#                                        </div>#}
{#                                    </div>#}
{#                                </div>#}
...
{#                                    <div class="collection-item-card">#}
{#                                        <div class="collection-photo">#}
{#                                            <a target="_self" title="Cooking🙆‍♀️" href="/bo-suu-tap/cooking-316371" class="photo">#}
{#                                                <img alt="Cooking🙆‍♀️" src="https://media.cooky.vn/collections/g32/316371/s400x400/cooky-collection-cover-c316371.jpg" class="img-responsive">#}
{#                                            </a>#}
{#                                            <div class="collection-item-acts">#}
{#                                                <div class="collection-item-acts-row">#}
{#                                                    <span class="stats-item"><span class="stat-count">310</span> Công thức</span>#}
{#                                                    <button title="thích" class="btn-follow btn-subscribe" data-collectionid="316371" data-issubscribed="False">#}
{#                                                        <span class="fa fa-bookmark-o"></span>#}
{#                                                    </button>#}
{#                                                </div>#}
{#                                            </div>#}
{#                                        </div>#}
{#                                        <div class="collection-header-box">#}
{#                                            <h3 class="title"><a target="_self" href="/bo-suu-tap/cooking-316371" title="Cooking🙆‍♀️">Cooking🙆‍♀️</a></h3>#}
{#                                        </div>#}
{#                                        <div class="creator">#}
{#                                            <a class="avatar" href="/thanh-vien/vungochuong/thong-tin" target="_self">#}
{#                                                <img src="https://media.cooky.vn/usr/g19/182675/avt/c80x80/cooky-avatar-636922275784184482.jpg">#}
{#                                            </a>#}
{#                                            <a class="name" href="/thanh-vien/vungochuong/thong-tin" target="_self">#}
{#                                                <span>Tạo bởi</span> vungochuong#}
{#                                            </a>#}
{#                                        </div>#}
{#                                    </div>#}
{#                                </div>#}
...
{#                        </div>#}
{#                    </div>#}
{#                    <script defer="" src="/dist/scripts/related.collection.min.js"></script>#}
{#                </div>#}

                <div class="right-content" style="margin: 15px 0 0 0;">
                    <script async="" src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js" style="display: none !important;"></script>
                    <!-- Cooky.Recipe.Detail -->
                    <ins class="adsbygoogle" style="display: none !important;" data-ad-client="ca-pub-9141160769841159" data-ad-slot="5911260551" data-ad-format="auto" data-full-width-responsive="true"></ins>
                    <script>
    ...
    <div class="cookybox-wrapper" id="cookybox-wrapper">
        <div class="cookybox-container no-photo" ng-class="{ 'no-photo' : currentBigPhoto === undefined }" style="overflow: auto;">
            <div title="Press 'Esc' to exit" style="cursor:pointer;z-index:999;" class="btn-close btn-close-box">
                <span class="fa fa-plus"></span>
            </div>
            <div class="cookybox-body" style="position: relative; display: block; width: 100%;">
                <div class="recipe-step-desc">
                    <div class="title ng-binding">
                        :
                        <span class="clearfix">(Bước <span class="highlight ng-binding"></span>)</span>
                    </div>
                    <div class="desc ng-binding">

                    </div>
                    <div class="photo-viewer-thumbs">
                        <div class="thumbs-photo-list">
                            <!-- ngRepeat: pic in currentStep.Pictures -->
                        </div>
                    </div>
                </div>
                <a href="javascript:void(0)" class="control-btn previous-btn previous  ng-hide" ng-click="prevThumbnail()" ng-show="showBack(currentStep, currentBigPhoto)" target="_self">
                    <span class="fa fa-angle-left"></span>
                </a>
                <a href="javascript:void(0)" class="control-btn next-btn next  ng-hide" ng-click="nextThumbnail()" ng-show="showNext(currentStep, currentBigPhoto)" target="_self">
                    <span class="fa fa-angle-right"></span>
                </a>
                <div class="cookybox-photo-big" style="">
                    <img class="big-photo" onload="rePositionPhoto()" style="left: 50px; top: 35px;">
                </div>

                <div class="steps-bar">
                    <a href="javascript:void(0)" class="btn-step next-step" ng-click="completed()" ng-hide="nextStepShow(currentStep)" target="_self">
                    <span class="text">
                        <span class="step-act">Hoàn tất</span>
                        <span class="step-label">(Đóng)</span>
                    </span>
                        <span class="fa fa-times step-icon"></span>
                    </a>
                    <a href="javascript:void(0)" class="btn btn-step next-step ng-hide" ng-click="nextThumbnail()" ng-show="nextStepShow(currentStep)" target="_self">
                    <span class="text">
                        <span class="step-act">Tiếp</span>
                        <span class="step-label ng-binding">Bước  ()</span>
                    </span>
                        <span class="fa fa-angle-double-right step-icon"></span>
                    </a>
                    <a href="javascript:void(0)" class="btn btn-step prev-step ng-hide" ng-click="prevThumbnail()" ng-show="prevStepShow(currentStep)" target="_self">
                    <span class="text">
                        <span class="step-act">Quay lại</span>
                        <span class="step-label ng-binding">Bước  ()</span>
                    </span>
                        <span class="fa fa-angle-double-left step-icon"></span>
                    </a>
