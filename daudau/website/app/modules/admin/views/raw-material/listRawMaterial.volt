                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary"
                                   href="{{ url.get() }}admin/raw-material/editRawMaterial/{{ item.getId() }}"
                                   title="{{ helper.translate('Chỉnh sửa nguyên liệu') }}"><i
                                            class="glyphicon glyphicon-pencil"></i></a>
                                <a id="deleteCustomer" class="btn btn-danger confirm_dialog"
                                   href="{{ url.get() }}admin/raw-material/deleteRawMaterial/{{ item.getId() }}"
                                   title="{{ helper.translate('Xóa nguyên liệu') }}"><i
