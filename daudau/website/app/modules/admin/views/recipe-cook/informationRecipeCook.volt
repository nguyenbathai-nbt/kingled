...
<div class="container recipe-header" style="width: 900px">
    <div class="rm">
        <div class="recipe-header-info">
            <div class="recipe-header-photo" id="recipe-header-photo-container">
                <img src="{{ recipe_cook.image.image_base }}" alt="Cách làm {{ recipe_cook.getName() }}"
                     id="image-logo" class="photo img-responsive u-photo">
                {% if recipe_cook.getLinkVideo() is sameas('https://www.youtube.com/embed/') %}

                    {% else %}
                        <a href="javascript:void(0);" id="btn-toogle-playing-video" target="_self" style="position: absolute;top: calc(50% - 46px);left: calc(50% - 46px);display: block;">
                            <img style="width: 92px; height: 92px;" src="/Content/img/icons/cooky-video-play-fill.png">
                        </a>
                        <div style="text-align: center; display: none;" id="videoPlaying" class="video-playing">
                            <iframe id="videoPlayer" width="688px" height="360px" src="{{ recipe_cook.getLinkVideo() }}" frameborder="0" allowfullscreen=""></iframe>
                        </div>
                {% endif %}
            </div>
                            ...
                            <span class="item" style="margin-right:5px">
                                ...
                                <span class="type">
                                    {% for item in list_category_type %}
                                        {% if item.getCode() is sameas('MUC-DICH') %}
                                            {% if list_category[item.getName()] is not null %}
                                                {% for item2 in list_category[item.getName()] %}
                                                        {% if list_recipe_category[item2.getId()] is defined %}
                                                            {{ item2.getName() }}
                                                        {% else %}
                    ...
                    <ul class="list-inline nomargin nopadding">
                        <li>
                            <div>
                                ...
                                <span class="duration-block"><b class="stats-count">{{ count_list_recipe_material }}</b></span>
                            </div>
                        </li>
                        <li>
                            <div>
                                ...
                                <span class="duration">
                                        <span class="duration-block">
                                            <b class="stats-count"><time title="{{ recipe_cook.getTimeDo() }}">{{ recipe_cook.getTimeDo() }}</time></b>p
                                        </span>
                                        <span class="value-title" title=" PT35M"></span>
                                    </span>
                            </div>
                ...
                <div id="recipe-detail">
                    <div class="recipe-ingredient-wrapper" id="ingredients-box">
                        <div class="recipe-box-heading">
                            <div class="col-md-12 col-sm-12 pull-left nopadding">
                                ...
                                <div class="desc" ng-show="servings>0">cho
                                    <span class="text-highlight"><strong ng-show="false" class="ng-hide">5</strong><strong class="ng-binding">2</strong></span> Phần ăn
                                </div>
                            </div>
                        </div>
                                        ...
                                        {% for item in list_recipe_material %}
                                            <li class="recipe-ingredient">
                                                <ul class="list-inline">
                                                    <li><span title="thêm vào giỏ đi chợ" style="cursor: pointer"
                    ...
                    <div class="recipe-detail-box">
                        <div class="recipe-direction-box">
                                                                ...
                                                                {% if list_step_image is not null %}
                                                                 {% if list_step_image[recipe_cook_id][item.getid()] is defined %}
                                                                    {% for item2 in list_step_image[recipe_cook_id][item.getid()] %}
                                                                        <a class="cooky-photo" href="javascript:void(0)" data-id="441426" data-group="1" data-dimen=" 1500x2000" target="_self">
                                                                            <img  class="lazy" src="{{ item2.getImageUrl() }}" style="display: inline;">
                                                                        </a>
                                                                    {% endfor %}
                                                                     {% endif %}
                                                                {% endif %}
                            ...
                            <div id="finishTab" class="create-form tab-pane clearfix active" style="padding: 0px 30px">
                                <div class="simple-container ng-scope" >
                                    ...
                                    {% for item in list_category_type %}
                                        <div class="form-row {{ item.getCode() }}" style="padding: 6px 0;clear: both;overflow: hidden;">
                                            <h4>{{ item.getName() }}</h4>
                                                            ...
                                                            <li class="col-sm-4 ng-scope" ng-repeat="map in mappings">
                                                                {% if list_recipe_category[item2.getId()] is defined %}
                                                                    <label style="cursor:pointer;" class="text-green">
                                                                        <input type="checkbox" name="category[]" class="ng-hide ng-pristine ng-untouched ng-valid ng-empty" value="{{ item2.getId() }} "checked="checked">
                                                                ...
                                                                {% else %}
                                                                    <label style="cursor:pointer;" class="text-gray">
                                                                        <input type="checkbox" name="category[]" class="ng-hide ng-pristine ng-untouched ng-valid ng-empty" value="{{ item2.getId() }}">
                                        ...
                                        <p id="message-{{ item.getCode() }}" style="display: none;color: red">Vui lòng chọn 1 phân loại của mục này</p>
                                    {% endfor %}
                                </div>
                            </div>
                        </div>
        ...
        <div style="margin-top: 15px" class="pull-right">
            <form action="" method="post">
                {% if btn is sameas('confirm') %}
                    <input type="hidden" name="id" value="{{ recipe_cook.getId() }}">
                    <button type="submit" class="btn btn-success" name="type" value="comfirm" style="margin-right: 7px">Xác nhận</button>
                    <button type="submit" class="btn btn-danger" name="type" value="reject" style="margin-right: 7px">Từ chối</button>
                {% elseif btn is sameas('reject') %}
                    <span class="btn-danger" style="padding: 8px;border-radius: 5px;margin-top: 5px;line-height: 30px"> Công thức bị từ chối</span>
                {% elseif btn is sameas('edit') %}
                    <input type="hidden" name="id" value="{{ recipe_cook.getId() }}">
                    <button type="submit" class="btn btn-success" name="type" value="edit" style="margin-right: 7px">Thay đổi</button>
                    <button type="submit" class="btn btn-danger" name="type" value="reject-edit" style="margin-right: 7px">Từ chối</button>
                {% endif %}
                <a class="btn btn-default" href="/admin/recipe-cook/listRecipeCook"> Trở về</a>
            </form>
            <a></a>
        </div>
    </div>
