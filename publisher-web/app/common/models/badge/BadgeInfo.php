...
class   BadgeInfo extends Model
{
     ...
     * @return mixed
     */
    public function getAIssuedId()
    {
        return $this->a_issued_id;
    }

    /**
     * @param mixed $a_issued_id
     */
    public function setAIssuedId($a_issued_id)
    {
        $this->a_issued_id = $a_issued_id;
    }
    ...
    public function getSequenceId()
    {
        ...
        $rs = $connection->query("select nextval('public.badge_info_id_seq');");
        $sid = $rs->fetchAll();
        return $sid[0][0];
    }
