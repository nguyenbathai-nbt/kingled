...
use CoursemosCloud\Common\Mail\Mailer;
use CoursemosCloud\Common\Ga\GAnalytic;
 ...
 */
$di->setShared('modules', function () {
    return include APP_PATH . "/config/modules.php";
});
$di->setShared('sbmenus', function() {
    return include APP_PATH . "/config/sidebar_menus.php";
});
